...
import nl.svh.microservices.core.review.persistence.MySqlBaseTestBase;
...
@SpringBootTest(webEnvironment = RANDOM_PORT, properties = {
        ...
        "logging.level.nl.svh=DEBUG",
        "eureka.client.enabled=false"})
class ReviewServiceApplicationTests extends MySqlBaseTestBase {
    ...
    private void sendCreateReviewEvent(int productId, int reviewId) {
        ...
        Event event = new Event(CREATE, productId, review);
        messageProcessor.accept(event);
    }

    private void sendDeleteReviewEvent(int productId) {
        Event event = new Event(DELETE, productId, null);
        messageProcessor.accept(event);
    }
}
